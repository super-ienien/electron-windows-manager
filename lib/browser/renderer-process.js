...
class RendererProcess
{
    ...
    open()
    {
        ...
        this.window.loadURL(this.config.params ? 'file://' + __dirname + '/windows' + this.config.url + "#/?"+querystring.stringify(this.config.params):'file://' + __dirname + '/windows' + this.config.url);
